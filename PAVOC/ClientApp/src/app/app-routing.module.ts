...
import { PlayCategoryComponent } from "./play-page/play-category/play-category.component";
...
const routes: Routes = [
  ...
  {
    path: "learn/:id",
    component: LearnCategoryComponent,
    canActivate: [AuthGuard],
  },
  { path: "play", component: PlayPageComponent, canActivate: [AuthGuard] },
  {
    path: "play/:id",
    component: PlayCategoryComponent,
    canActivate: [AuthGuard],
  },
  {
    path: "leaderboard",
...
export const routingComponents = [
  HomeComponent,
  LearnPageComponent,
  LearnCategoryComponent,
  PlayPageComponent,
  PlayCategoryComponent,
